...
// TODO: Uncomment the following line of code to see the output in the browser console
 console.log('Sum in  arrow function:',sum(1, 2, 3, 4));
...
// TODO: Uncomment the following line of code to see the output in the browser console
 console.log('objects in  arrow function:',objectLit());
...
// TODO: Uncomment the following line of code to see the output in the browser console
 console.log('multiple parameters in  arrow function:',sumAndProduct(3, 9));
...
// let Student.prototype.greeting = () => `Hi, my name is ${this.name}`;
...
//Student object that refers to the Student object that is being called.
// 2. What is "this" when joe.scopeArrow() is invoked?
//window object that refers to the window object that is being called.
// 3. Explain why "this" is different when an arrow function is used.
// this is different when an arrow function is used because it refers to the object that is being called.
